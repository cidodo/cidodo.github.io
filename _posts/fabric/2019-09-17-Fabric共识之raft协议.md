...
![raft-图1.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图1.png)
...
![raft-图2.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图2.png)
...
![raft-图3.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图3.png)
...
![raft-图4.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图4.png)


> 图 4：服务器状态。跟随者只响应来自其他服务器的请求。如果跟随者接收不到消息，那么他就会变成候选人并发起一次选举。获得集群中大多数选票的候选人将成为领导者。在一个任期内，领导人一直都会是领导人直到自己宕机了。

![raft-图5.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图5.png)
...
![raft-图6.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图6.png)
...
![raft-图7.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图7.png)
...
![raft-图8.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图8.png)
...
![raft-图9.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图9.png)
...
![raft-图10.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图10.png)
...
![raft-图11.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图11.png)
...
![raft-图12.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图12.png)
...
![raft-图13.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图13.png)
...
![raft-图14.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图14.png)
...
![raft-图15.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图15.png)
...
![raft-图16.png](/img/fabric/共识算法/Fabric共识之Raft协议/raft-图16.png)
